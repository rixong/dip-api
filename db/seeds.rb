...
Repair.create(category: 'plumbing', description: 'No hot water', submission_date: 20200621, priority: false, pending:true, user_id: 1, cabin_id: 2, annual_report_id: 1)
...
Repair.create(category: 'capentry', description: 'Deck is rotting out', submission_date: 20200803, priority: false, pending:true, user_id: 3, cabin_id: 1, annual_report_id: 1)
