...
Repair.create(category: 'plumbing', description: 'Leaky faucet', submission_date: 20200601, priority: true, followup: 'none', pending:true, user_id: 1, cabin_id: 1, annual_report_id: 1)
Repair.create(category: 'plumbing', description: 'No hot water', submission_date: 20200621, priority: false, followup: 'none', pending:true, user_id: 1, cabin_id: 2, annual_report_id: 1)
Repair.create(category: 'electrical', description: 'Kitchen light shorted out.', submission_date: 20200711, priority: true, followup: 'none', pending:true, user_id: 2, cabin_id: 1, annual_report_id: 1)
Repair.create(category: 'capentry', description: 'Deck is rotting out', submission_date: 20200803, priority: false, followup: 'none', pending:true, user_id: 3, cabin_id: 1, annual_report_id: 1)

Reservation.create(arrival: 20200531, departure: 20200602, pending: true, user_id: 1, cabin_id: 1, annual_report_id: 1)
Reservation.create(arrival: 20200604, departure: 20200610, pending: true, user_id: 2, cabin_id: 1, annual_report_id: 1)
Reservation.create(arrival: 20200605, departure: 20200610, pending: true, user_id: 2, cabin_id: 2, annual_report_id: 1)
Reservation.create(arrival: 20200601, departure: 20200620, pending: true, user_id: 3, cabin_id: 3, annual_report_id: 1)
Reservation.create(arrival: 20200601, departure: 20200603, pending: true, user_id: 3, cabin_id: 5, annual_report_id: 1)