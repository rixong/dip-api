...
Cabin.create(name: 'Pine Away', description: 'Down by the waters edge.', multiplier: 0.75)
Cabin.create(name: 'Winter Haven', description: 'Ken and Betty Emersons home built in the 70s. Two bedroom.', multiplier: 0.5)
Cabin.create(name: 'Gray House', description: 'The second to be built. Sewells home originally.', multiplier: 0.5)
...
Reservation.create(arrival: 20200531, departure: 20200602, user_id: 1, cabin_id: 1, annual_report_id: 1)
Reservation.create(arrival: 20200604, departure: 20200610, user_id: 2, cabin_id: 1, annual_report_id: 1)
Reservation.create(arrival: 20200605, departure: 20200610, user_id: 2, cabin_id: 2, annual_report_id: 1)
Reservation.create(arrival: 20200601, departure: 20200620, user_id: 3, cabin_id: 3, annual_report_id: 1)
Reservation.create(arrival: 20200601, departure: 20200603, user_id: 3, cabin_id: 5, annual_report_id: 1)